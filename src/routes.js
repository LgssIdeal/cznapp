...
import InsumoListView from './views/insumo/InsumoListView';
import InsumoFormView from './views/insumo/InsumoFormView';
import SolicitacaoPlantonistaListView from './views/solicitacao/SolicitacaoPlantonistaListView';
